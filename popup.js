...
// Build an absolute chrome-extension:// base so the OCR worker (which runs
// in its own execution context) resolves paths correctly.
const EXTENSION_BASE = location.href.replace(/popup\.html.*$/, '');
...
async function runOcrInSandbox(imageDataUrl) {
